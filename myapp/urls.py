...
from .views import (place_order,DashboardView)
...
urlpatterns = [
    ...
    path('inventory_adjustments/create/', views.inventory_adjustmentsCreateView.as_view(), name='inventory_adjustments_create'),
